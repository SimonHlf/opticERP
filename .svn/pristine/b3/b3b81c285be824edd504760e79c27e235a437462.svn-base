...
public interface UserInfoManager {
	 ...
	 * @description
	 * @author wm
	 * @date 2017-4-11 上午10:54:00
	 * @param userId
	 * @return
	 * @throws WEBException
	 */
	List<UserInfo> listInfoById(Integer userId)throws WEBException;
	
	/**
	 * 根据主键修改用户密码
	 * @description
	 * @author wm
	 * @date 2017-4-11 上午10:55:56
	 * @param userId
	 * @param newPass
	 * @return
	 * @throws WEBException
	 */
	boolean updateNewPass(Integer userId,String newPass)throws WEBException;
}
