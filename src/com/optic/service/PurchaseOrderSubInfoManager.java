...
public interface PurchaseOrderSubInfoManager {
	 ...
	 * @throws WEBException
	 */
	Integer addPOS(Integer poId,Integer bId,Integer pId,Integer pNum,Double pMoney,Double pTotalMoney)throws WEBException;
	 ...
	 * @throws WEBException
	 */
	boolean updatePOS(Integer posId,Integer bId,Integer pId,Integer pNum,Double pMoney,Double pTotalMoney)throws WEBException;
