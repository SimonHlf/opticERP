...
public interface PLossInfoManager {
	 ...
	 * @throws WEBException
	 */
	Integer addPL(Integer issId,Integer proId,Integer proNewId,Timestamp sTime,String batchNo,Integer matchNum)throws WEBException;
	 ...
	 * @throws WEBException
	 */
	List<PLossInfo> listUnComInfoByProId(Integer pId)throws WEBException;
}
