...
public class ProductInfo implements java.io.Serializable {
	...
	private Double proPriceL;
	private Double proPriceH;
	private Double proPriceA;
	...
	private Set<PLossInfo> pLossInfos = new HashSet<PLossInfo>();
	...
	public ProductInfo(ProductTypeInfo productTypeInfo,String proNo,
			...
			String proUnit,String proType2,DepartmentInfo depInfo,Double proPriceL,Double proPriceH,Double proPriceA,
	...
	public Double getProPriceL() {
		return proPriceL;
	}

	public void setProPriceL(Double proPriceL) {
		this.proPriceL = proPriceL;
	}

	public Double getProPriceH() {
		return proPriceH;
	}

	public void setProPriceH(Double proPriceH) {
		this.proPriceH = proPriceH;
	}

	public Double getProPriceA() {
		return proPriceA;
	}

	public void setProPriceA(Double proPriceA) {
		this.proPriceA = proPriceA;
	}
	...
	public Set<PLossInfo> getpLossInfos() {
		return pLossInfos;
	}

	public void setpLossInfos(Set<PLossInfo> pLossInfos) {
		this.pLossInfos = pLossInfos;
	}
