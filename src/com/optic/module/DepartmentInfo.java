...
public class DepartmentInfo implements java.io.Serializable {
	...
	private Set<ProductInfo> proInfos = new HashSet<ProductInfo>();
	...
	public DepartmentInfo(Integer id,String depName) {
		this.id = id;
	...
	public Set<ProductInfo> getProInfos() {
		return proInfos;
	}

	public void setProInfos(Set<ProductInfo> proInfos) {
